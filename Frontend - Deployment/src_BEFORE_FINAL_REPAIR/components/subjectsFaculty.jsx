...
import qualifying examsIcon from "/src/assets/symbols/subjects.svg";
...
const SideBarDropDown = ({
  ...
  const unassignedqualifying exams = subjects.filter(
    (subject) =>
  ...
  useEffect(() => {
    const handleResize = () => {
      ...
      if (wasSmallScreen && !isNowSmallScreen && isOpen) {
        ...
        setSearchTerm("");
        setfilteredSubjects(assignedqualifying exams);
  ...
  const fetchAssignedqualifying exams = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setAssignedqualifying exams(sortedSubjects);
