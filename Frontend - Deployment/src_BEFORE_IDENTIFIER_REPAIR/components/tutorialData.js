...
export const faqData = [
  ...
  },
  {
    ...
    a: "There are four main roles: Student (take exams, view results), Faculty (create/manage questions), Program Chair (approve questions, manage qualifying exams), and Admin/Dean (system oversight, user management).",
  },
  {
