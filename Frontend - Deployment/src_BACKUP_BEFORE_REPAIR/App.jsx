...
import qualifying examsArchive from "./pages/qualifying examsArchive";
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route
          path="/program-chair/qualifying exams"
          element={<ProtectedRoute element={<Layout />} />}
        >
          <Route
            index
        ...
        {/* =====================================================
            ASSOCIATE DEAN qualifying exams
            ===================================================== */}

        <Route
          path="/asso-dean/qualifying exams"
          element={<ProtectedRoute element={<Layout />} />}
        >
          <Route
            index
          ...
          <Route
            path="archive"
            element={<qualifying examsArchive />}
          />
