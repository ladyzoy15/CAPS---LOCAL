...
export const IntroductionSection = () => (
  <div>
    <SectionHeader
      ...
      subtitle="A comprehensive web-based platform designed to help students prepare for exams through practice tests, while giving faculty and administrators the tools they need to manage questions, qualifying exams, and results."
    />
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
      <FeatureCard
        icon="bx-edit-alt"
        title="Practice Exams"
        description="Take timed practice exams with randomized questions across multiple qualifying exams."
      />
      <FeatureCard
        icon="bx-whiteboard"
        title="Classes"
    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      {[
        ...
        },
        {
          ...
          role: "Program Chair",
          desc: "Approve questions, manage qualifying exams, and view analytical reports.",
...
export const AnalyticsSection = () => (
  <div>
    ...
    <p className="mb-4 text-sm leading-relaxed text-gray-600">
      ...
      performance over time. Identify strong qualifying exams and areas that need more
    ...
    />
    <InfoBox type="tip">
      <strong>Study Tip:</strong> Focus your study sessions on qualifying exams where
...
export const qualifying examselectionSection = () => (
  <div>
    <SectionHeader
      tag="Student Features"
      title="Subject Selection"
      subtitle="Browse and choose from available qualifying exams to practice."
    />
    <p className="mb-4 text-sm leading-relaxed text-gray-600">
      The subject selection screen lets you browse all available qualifying exams
      organized by program. Select a subject to view available practice exams
      and start preparing for your tests.
    </p>
    <ScreenshotPlaceholder
      label="Subject Selection"
      caption="Browse and select qualifying exams to practice."
    />
    <Divider />
  </div>
);
...
/* ─── SECTION: Managing qualifying exams ─── */
export const Managingqualifying examsSection = () => (
  <div>
    <SectionHeader
      tag="Program Chair Features"
      title="Managing qualifying exams"
      subtitle="Add, edit, and organize qualifying exams within your program."
    />
    <ScreenshotPlaceholder
      label="Subject Management"
      caption="Add, edit, or archive qualifying exams within the system."
    />
    <InfoBox type="info">
