      ...
      if (isFormOpen && subjectID) {
        try {
          ...
          const qeResponse = await fetch(
            `${apiUrl}/qualifying exams/${subjectID}/exam-questions-status`,
            {
              headers: {
    ...
    try {
      ...
      if (localExamQuestionsEnabled !== isExamQuestionsEnabled) {
        const endpoint = localExamQuestionsEnabled
          ? `${apiUrl}/qualifying exams/${subjectID}/enable-exam-questions`
          : `${apiUrl}/qualifying exams/${subjectID}/disable-exam-questions`;
      ...
      if (res.ok) {
        ...
        // Dispatch refresh event to update the qualifying exams list
