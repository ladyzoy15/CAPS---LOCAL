...
const Layout = () => {
  ...
  const isLibrariesPage =
    ...
    location.pathname === "/dean/qualifying exams" ||
    location.pathname === "/asso-dean/qualifying exams" ||
    location.pathname === "/program-chair/qualifying exams" ||
    location.pathname === "/faculty/qualifying exams" ||
    location.pathname === "/student/qualifying exams";
