...
import Allqualifying examsDropDownProgramChair from "./qualifying examsProgramChair";
import Assignedqualifying examsDropDown from "./qualifying examsFaculty";
...
const Sidebar = ({
  ...
  const isActive = (path) => {
    ...
    if (path === "/archive") {
      ...
      return (
        location.pathname ===
          "/dean/qualifying exams/archive" ||
        location.pathname ===
          "/asso-dean/qualifying exams/archive"
      );

    }


    if (path === "/dean/qualifying exams/archive") {
    ...
    if (path === "/asso-dean/qualifying exams/archive") {
                          ...
                          <img
                            src={
                              isActive(
                                ...
                                ? qualifying examsIconH
                                : qualifying examsIcon
                            }
  ...
  return (
    <>
      ...
      >
        ...
        {/* =====================================================
            qualifying exams / IMPORT / EXPORT / ARCHIVE
        ===================================================== */}
