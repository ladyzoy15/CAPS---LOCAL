...
function LandingPage() {
  ...
  return (
    <>
      ...
      <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-[#080d22] via-[#101a38] to-[#1c1640] pt-8">
        ...
        <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
          ...
          <div className="absolute -left-32 -top-32 h-[420px] w-[420px] rounded-full bg-blue-600/25 blur-[130px]" />

          <div className="absolute -right-40 top-[15%] h-[500px] w-[500px] rounded-full bg-purple-600/25 blur-[140px]" />

          <div className="absolute -bottom-32 -left-20 h-[460px] w-[460px] rounded-full bg-orange-500/25 blur-[140px]" />

          <div className="absolute bottom-[8%] right-[15%] h-[360px] w-[360px] rounded-full bg-yellow-400/15 blur-[130px]" />

          <div className="absolute left-[40%] top-[35%] h-[280px] w-[280px] rounded-full bg-white/5 blur-[100px]" />

          <div className="absolute left-[5%] top-[48%] h-[220px] w-[220px] rounded-full bg-orange-400/10 blur-[100px]" />
        ...
        >
          ...
          <span className="outfit-500 text-[20px] tracking-wide text-white md:text-[24px]">
            CAPS-REVIEW
          </span>
        ...
        <div className="relative isolate w-full max-w-[1450px] px-2 md:px-4">
          ...
          >
            ...
            <div className="pointer-events-none absolute inset-x-16 top-0 z-20 h-px bg-gradient-to-r from-transparent via-white/90 to-transparent" />

            <div className="pointer-events-none absolute left-1/2 top-[-100px] h-[220px] w-[420px] -translate-x-1/2 rounded-full bg-white/5 blur-[80px]" />

            <div className="pointer-events-none absolute -bottom-[30%] -left-[5%] h-[380px] w-[430px] rounded-full bg-orange-500/20 blur-[150px]" />

            <div className="pointer-events-none absolute -bottom-[20%] right-[-5%] h-[320px] w-[370px] rounded-full bg-purple-600/20 blur-[140px]" />

            <div className="pointer-events-none absolute left-[32%] top-[-25%] h-[260px] w-[300px] rounded-full bg-yellow-400/8 blur-[120px]" />
            ...
            <div className="outfit finisher-header relative z-10 overflow-hidden rounded-[40px] text-white md:rounded-[50px]">
              ...
              >
                ...
                <div className="relative mx-auto flex min-h-[620px] max-w-[1280px] items-center">
                  ...
                  <div className="pointer-events-none absolute right-[2%] top-[2%] hidden h-[520px] w-[520px] rounded-full border border-purple-400/20 md:block">

                    <div className="absolute inset-8 rounded-full border border-orange-300/40" />

                    <div className="absolute inset-24 rounded-full border border-purple-300/15 border-dashed" />

                    <span className="absolute -left-1 top-[50%] h-2 w-2 rounded-full bg-orange-300 shadow-[0_0_16px_rgba(251,146,60,.9)]" />

                    <span className="absolute right-[8%] top-[16%] h-2 w-2 rounded-full bg-pink-300 shadow-[0_0_16px_rgba(244,114,182,.9)]" />

                    <span className="absolute bottom-[8%] right-[15%] h-2 w-2 rounded-full bg-purple-300 shadow-[0_0_16px_rgba(168,85,247,.9)]" />

                  </div>

                  {/* =================================================
                      TECHNICAL CIRCUITS
                      JSX-SAFE SVG ATTRIBUTES
                  ================================================= */}

                  <svg
                    className="pointer-events-none absolute right-[-2%] top-[10%] hidden h-[540px] w-[580px] opacity-55 md:block"
                    viewBox="0 0 560 520"
                    fill="none"
                  >
                  ...
                  >
                    ...
                    <div className="pointer-events-none absolute -bottom-24 -left-20 h-48 w-48 rounded-full bg-orange-500/15 blur-[75px]" />

                    {/* COLLEGE OF ENGINEERING LABEL */}

                    <div className="relative z-10 mb-5 flex flex-col items-start gap-2">

                      <div className="h-[4px] w-[92px] rounded-full bg-gradient-to-r from-yellow-300 via-amber-400 to-orange-400 shadow-[0_0_12px_rgba(250,204,21,.28)]" />

                      <span className="outfit-600 text-[13px] font-semibold uppercase tracking-[2.2px] text-yellow-300 md:text-[14px]">
                    ...
                    >
                      ...
                      <span className="bg-gradient-to-r from-orange-300 via-yellow-300 to-orange-500 bg-clip-text text-transparent">
                        EXAMS
                      </span>

                    </h1>

                    <div className="relative z-10 mt-7 h-1 w-20 rounded-full bg-gradient-to-r from-purple-500 via-pink-500 to-orange-400" />

                    <p className="outfit-400 relative z-10 mt-7 max-w-md text-[15px] leading-6 text-gray-300 md:text-[16px]">
                    ...
                    <div className="relative z-10 mt-8 flex flex-wrap items-center gap-5">
                      ...
                      <button
                        ...
                        className="
                          ...
                          bg-gradient-to-r from-orange-400 via-orange-500 to-purple-600
                          px-7 py-3.5 text-[14px] font-medium text-white
                          shadow-[0_10px_28px_rgba(99,102,241,.30)]
                          transition-all duration-300
                          hover:-translate-y-0.5
                          hover:shadow-[0_14px_34px_rgba(249,115,22,.38)]
                          active:scale-95
                        "
                      >
                  ...
                  >
                    ...
                    <div className="pointer-events-none absolute right-[8%] top-[8%] h-[430px] w-[430px] rounded-full bg-purple-500/10 blur-[120px]" />

                    <div className="pointer-events-none absolute bottom-[5%] right-[15%] h-[300px] w-[300px] rounded-full bg-orange-400/10 blur-[100px]" />
                    ...
                    >
                      ...
                      >
                        ...
                        <g fill="#38bdf8" fillOpacity="0.22">
                    ...
                    <div
                      className="
                        ...
                        via-emerald-900
                        to-slate-950
                        shadow-[0_25px_45px_rgba(0,0,0,.55)]
                      "
                    >
                      ...
                      >
                        ...
                        <div className="absolute inset-[7px] rounded-[3px] bg-black ring-1 ring-purple-400/30" />
                    ...
                    >
                      ...
                      <div className="absolute inset-3 rounded-md bg-black ring-1 ring-purple-300/30" />

                      <div className="absolute left-1/2 top-2 h-1 w-5 -translate-x-1/2 rounded-full bg-white/20" />

                      <div className="absolute -left-2 top-3 h-[2px] w-2 bg-purple-300/70 shadow-[0_10px_0_rgba(168,85,247,.7),0_20px_0_rgba(168,85,247,.7),0_30px_0_rgba(168,85,247,.7),0_40px_0_rgba(168,85,247,.7)]" />

                      <div className="absolute -right-2 top-3 h-[2px] w-2 bg-purple-300/70 shadow-[0_10px_0_rgba(168,85,247,.7),0_20px_0_rgba(168,85,247,.7),0_30px_0_rgba(168,85,247,.7),0_40px_0_rgba(168,85,247,.7)]" />
                    ...
                    >
                      ...
                      <div
                        className="
                          ...
                          to-slate-900/50
                          p-[5px]
                          shadow-[0_18px_38px_rgba(0,0,0,.26),inset_0_1px_1px_rgba(255,255,255,.45)]
                          backdrop-blur-xl
                      ...
                      >
                        ...
                        <div className="pointer-events-none absolute inset-0 rounded-[48px] bg-gradient-to-br from-white/30 via-transparent to-black/30" />
                        ...
                        >
                          ...
                          <div
                            className="
                              ...
                              via-slate-100
                              to-slate-400
                              shadow-[0_9px_16px_rgba(0,0,0,.38),inset_0_2px_4px_rgba(255,255,255,.95)]
                            "
                          >
                          ...
                          <div
                            className="
                              ...
                              via-slate-200
                              to-slate-500
                              shadow-[0_6px_11px_rgba(0,0,0,.42),inset_0_2px_3px_rgba(255,255,255,.95)]
                            "
                          >
                ...
                <div
                  className="
                    ...
                    bg-[#111936]/85
                    px-6 py-6
                    shadow-[0_14px_45px_rgba(0,0,0,.30)]
                    backdrop-blur-2xl
                    sm:mx-6
                    md:absolute
                    md:bottom-5
                ...
                >
                  ...
                  <div className="flex flex-1 items-center gap-4">
                    ...
                    <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full border border-orange-300/30 bg-purple-500/10 md:h-16 md:w-16">
                    ...
                    <div>
                      ...
                      <h3 className="outfit-700 text-[14px] text-white md:text-[15px]">
                        CIVIL ENGINEERING
                      </h3>
                  ...
                  <div className="hidden h-16 w-px bg-white/20 lg:mx-5 lg:block" />
        ...
        >
          ...
          <div className="pointer-events-none absolute inset-x-20 top-0 h-px bg-gradient-to-r from-transparent via-white/90 to-transparent" />

          <div className="pointer-events-none absolute -right-32 -top-32 h-[280px] w-[280px] rounded-full bg-blue-500/10 blur-[100px]" />
          ...
          <div className="relative z-10 flex flex-col gap-6 text-center md:flex-row md:items-center md:justify-between md:text-left">
            ...
            <div className="flex-1">
              ...
              <h2 className="outfit-500 text-[24px] font-semibold leading-tight md:text-[25px] lg:text-[33px] xl:text-[45px]">
            ...
            <div className="flex-1 xl:max-w-md">
              ...
              <p className="outfit-400 mx-auto max-w-sm text-[14px] text-gray-300 md:mx-0 md:max-w-none lg:text-[16px] xl:text-[18px]">
          ...
          <div className="relative z-10 mt-10 h-px w-full bg-gradient-to-r from-transparent via-white/70 to-transparent" />
          ...
          <div className="relative z-10 mt-12 text-center">
            ...
            <div className="mb-4">
              ...
              <span
                className="
                  ...
                  px-4 py-1.5
                  text-orange-300
                  shadow-[0_4px_20px_rgba(249,115,22,0.08)]
                  backdrop-blur-md
                  md:text-[18px]
                  lg:text-lg
                "
            ...
            <h3 className="outfit-700 mt-8 text-white md:mt-12 md:text-4xl lg:text-[24px] xl:text-3xl">
              Everything you need for smarter exam review
            </h3>

            <p className="outfit-400 mx-auto mt-8 max-w-2xl text-[14px] text-gray-300 lg:text-[16px] xl:text-lg">
            ...
            <div className="mt-20 grid grid-cols-1 gap-8 md:grid-cols-3">
              ...
              <div
                className="
                  ...
                  bg-white/5
                  p-6
                  shadow-[0_10px_35px_rgba(0,0,0,0.25),0_0_35px_rgba(249,115,22,0.08)]
                  backdrop-blur-2xl
                  transition-all duration-300
                  hover:-translate-y-2
              ...
              >
                ...
                <h4 className="outfit-700 mb-2 font-bold text-white lg:text-[16px] xl:text-xl">
                  Review Quiz Creation
                </h4>

                <p className="text-gray-300 md:text-[14px] lg:text-base">
              ...
              <div
                className="
                  ...
                  bg-white/5
                  p-6
                  shadow-[0_10px_35px_rgba(0,0,0,0.25),0_0_35px_rgba(168,85,247,0.08)]
                  backdrop-blur-2xl
                  transition-all duration-300
                  hover:-translate-y-2
                  hover:shadow-[0_18px_45px_rgba(0,0,0,0.35)]
              ...
              <div
                className="
                  ...
                  bg-white/5
                  p-6
                  shadow-[0_10px_35px_rgba(0,0,0,0.25),0_0_35px_rgba(250,204,21,0.08)]
                  backdrop-blur-2xl
                  transition-all duration-300
                  hover:-translate-y-2
                  hover:shadow-[0_18px_45px_rgba(0,0,0,0.35)]
        ...
        >
          ...
          <div className="pointer-events-none absolute -right-32 -top-32 h-[300px] w-[300px] rounded-full bg-purple-500/10 blur-[120px]" />
          ...
          <div className="mx-auto mt-4 w-full max-w-[1200px] px-6 md:mt-10 lg:-mt-10">
            ...
            <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-2">
              ...
              <div className="flex flex-col gap-6 text-center lg:text-left">
                ...
                <h2 className="outfit-500 mb-6 text-[28px] leading-tight text-white lg:text-[30px] xl:text-4xl">
                ...
                >
                  ...
                  <div>
                    ...
                    <h3 className="outfit-700 mb-2 text-white lg:text-[18px] xl:text-xl">
                      Build Your Own Review Materials
                    </h3>

                    <p className="outfit-400 text-[13px] text-white lg:text-[14px] xl:text-base">
                ...
                >
                  ...
                  <div>
                    ...
                    <h3 className="outfit-700 mb-2 font-bold text-white lg:text-[18px] xl:text-xl">
                      Quick Review Export
                    </h3>
          ...
          <div className="mx-auto w-full md:max-w-[800px] lg:max-w-[1000px] xl:max-w-[1100px]">
            ...
            <div
              className="
                ...
                rounded-[36px]
                border border-white/15
                shadow-[0_15px_50px_rgba(0,0,0,0.40)]
              "
            >
                  ...
                  <div className="mt-2 flex justify-start md:mt-4">
                    ...
                    <button
                      ...
                      className="
                        ...
                        shadow-[0_8px_25px_rgba(250,204,21,0.28)]
                        transition-all
                        hover:-translate-y-0.5
        ...
        <section className="relative w-full max-w-[1450px] px-6 pb-16">
          ...
          >
            ...
            <h2 className="outfit-700 text-2xl text-white md:text-3xl lg:text-4xl xl:text-5xl">
              More CAPS-REVIEW Features to come!
            </h2>

            <p className="outfit-400 mt-4 text-sm text-gray-400 md:text-[14px] lg:text-base">
        ...
        <footer
          className="
            ...
            bg-white/5
            shadow-[0_-10px_40px_rgba(0,0,0,0.20)]
            backdrop-blur-2xl
          "
        >
          ...
          >
            ...
            <div className="flex flex-col items-start gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex h-7 w-7 items-center justify-center rounded-full border border-white/15 bg-white/5 backdrop-blur-md">
                ...
                <span className="outfit-700 text-base text-white">
                  CAPS-REVIEW
                </span>
            ...
            <div className="grid grid-cols-2 gap-6 md:grid-cols-3 md:gap-10">
              ...
              <div>
                ...
                <h4 className="outfit-700 mb-2 text-xs uppercase tracking-wide text-gray-300">
                  Product
                </h4>
                ...
                <ul className="space-y-1 text-xs md:text-sm">
                  ...
                  <li>
                    ...
                    <a
                      href="#features"
                      className="outfit-400 transition hover:text-white"
                    >
                      Features
                    </a>
