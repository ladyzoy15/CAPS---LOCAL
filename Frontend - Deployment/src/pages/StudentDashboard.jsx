      ...
      <div className="outfit-400 relative mt-8 min-h-screen bg-white pb-12 lg:mt-0">
        ...
        <div className="relative px-5 pt-10 pb-4 text-center md:px-6 md:pt-14 md:pb-6">
          ...
          <button
            ...
            title="What's new"
            className="outfit-600 absolute top-3 right-4 flex cursor-pointer items-center gap-1.5 rounded-xl bg-orange-500 px-4 py-2 text-[12px] font-bold text-white shadow shadow-orange-200 transition hover:bg-orange-600 active:scale-95 md:top-5 md:right-6"
          >
