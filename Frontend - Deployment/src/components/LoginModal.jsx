    ...
    <>
      ...
      >
        ...
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -top-24 -left-20 h-[380px] w-[380px] rounded-full bg-orange-500/60 blur-[120px]" />
          <div className="absolute -right-24 top-10 h-[340px] w-[340px] rounded-full bg-yellow-800/60 blur-[120px]" />
          <div className="absolute -bottom-28 left-1/3 h-[360px] w-[360px] rounded-full bg-amber-600/40 blur-[130px]" />
        </div>

        {/* Modal card - dark glass */}
        <div
          className="relative z-10 w-full max-w-[420px] overflow-hidden rounded-3xl border border-black/50 bg-white/5 p-8 shadow-[0_25px_70px_rgba(0,0,0,0.55)] backdrop-blur-2xl"
        ...
        >
          ...
          <button
            onClick={onClose}
            className="absolute top-4 right-4 z-10 flex h-8 w-8 cursor-pointer items-center justify-center rounded-full border border-black/50 bg-block/10 text-black-300 backdrop-blur-md transition hover:bg-white/15 hover:text-white"
            aria-label="Close"
          >
            <svg
          ...
          >
            ...
            <p className="outfit-400 text-center text-sm text-black-400">
              ...
              <span
                ...
                className="cursor-pointer font-medium text-red-400 hover:underline"
              >
                Register
              </span>
            </p>
