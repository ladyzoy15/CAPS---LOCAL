...
const CombinedExamQuestionForm = ({ subjectID, onComplete, onCancel }) => {
  ...
  const handleSubmit = async () => {
    ...
    if (!formData.choices.some((choice) => choice.isCorrect)) {
    ...
    try {
      ...
      questionFormData.append("coverage", formData.coverage);
      questionFormData.append(
        "questionText",
        editorRef.current.innerHTML.trim(),
      );
      questionFormData.append("score", formData.score);
      questionFormData.append("difficulty", formData.difficulty);
      questionFormData.append("status", formData.status);
      questionFormData.append("purpose", formData.purpose);
