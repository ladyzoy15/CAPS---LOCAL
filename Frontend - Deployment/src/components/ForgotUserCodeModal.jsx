...
export default function ForgotUserCodeModal({
  isOpen,
  onClose,
  onSwitchToLogin,
}) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast(
        data.message || "User code reset link sent successfully!",
        "success",
      );
      setEmail("");
        ...
        >
          ...
          <div className="mb-6 text-center">
            ...
            <p className="outfit-400 mt-1 text-sm text-gray-500">
              Enter your email and we'll send you a link to reset your ID code.
            </p>
          </div>
